...
2. It is almost identical to the direct invocation API experience (app developers only need to add a small amount of code)adb shell sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.sh
